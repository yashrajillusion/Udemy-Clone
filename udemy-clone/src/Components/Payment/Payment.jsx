          ...
          {/* ======================================================================= */}
              ...
              <div className='payment_options'>
                   <div className='creditcard_option'>
                      ...
                      <span className='payment_span_images'>
                          ...
                          <img src="	https://www.udemy.com/staticx/udemy/images/v9/card-visa.svg" alt="" />
                          <img src="	https://www.udemy.com/staticx/udemy/images/v9/card-discover.svg" alt="" />
                          <img src="	https://www.udemy.com/staticx/udemy/images/v9/card-dinersclub.svg" alt="" />
                          <img src="	https://www.udemy.com/staticx/udemy/images/v9/card-amex.svg" alt="" />
                           <img src="	https://www.udemy.com/staticx/udemy/images/v9/card-rupay.svg" alt="" />
                      </span>
                   </div>
                   ...
                   <div className='creditcard_option'>
                      ...
                      <span className='payment_span_images images_pay'>
                        <img src="	https://www.udemy.com/staticx/udemy/images/v9/hpp-upi.svg" alt=""/>
                        </span>
                   </div>
                   ...
                   <div className='creditcard_option'>
                      ...
                      <span className='payment_span_images images_pay1'>
                        <img src="	https://www.udemy.com/staticx/udemy/images/v9/hpp-paytm.svg" alt="" />
                        </span>
                   </div>
                   ...
                   <div className='creditcard_option'>
                      ...
                      <span className='payment_span_images  images_pay2'>
                        <img src="	https://www.udemy.com/staticx/udemy/images/v9/hpp-billdesk-online.svg" alt="" />
                        </span>
                   </div>
                   <div className='creditcard_option'>
                      <input type = "radio" className='input_radio'></input>
            ...
            <div className='card_detailsDiv'>
                 <div className = "input_cardnameDiv">
                    <input className = "input_cardname" type = "text" placeholder='Name on Card'></input>
                 </div>
                 <div className='input_cardnumDiv'>
                     <input className='input_cardnum' type= "text" placeholder='Card Number'></input>
                 </div>
                 <div className='card_validity'>
                     ...
                     <input className='input_securitynum' type= "text" placeholder='Security Code'>
  ...
  <div className = "form_left">
      ...
      <table className = "price_table">
          <tr>
             ...
             <td><div><span classname = "course_price"> &#8377;3,499</span></div></td>
          </tr>
          <tr>
             <td>Coupon discounts:</td>
             <td><div classname = "course_price"><span> &#8377;3,044</span></div></td>
          </tr>
          <hr></hr>
          <tr>
             <td><b>Total:</b></td>
             <td><div classname = "course_price"><span> <b>&#8377;455 </b></span></div></td>
          </tr>
      </table>
      ...
      <div className = "terms_conditions"><span>By completing your purchase you agree to these <a href = "#">Terms of Service</a></span></div>

      <button id = "complete_payment">Complete Payment</button>
  </div>
  </div>
  ...
  <div className='ordersummary'>
      <h2>Order Summary</h2>
         ...
         <div className='ordersummery_details'>
           <div>
             <img src="https://img-c.udemycdn.com/course/100x100/354176_fe73_5.jpg" alt="" />  </div>
             <div className='order_course'>    
             <h4>Selenium WebDriver with Java-Basics to Advanced + Frameworks</h4> </div>
             <div>
             <div classname = "course_price"><span>&#8377;455</span></div>
             <div classname = "course_price"><span><del>&#8377;3,499</del></span></div>
