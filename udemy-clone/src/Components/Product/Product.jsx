    ...
    <div>
       <div className='BlackBox'>
          ...
          <div className='flex purpal'>
               <h5>Development</h5>
               <span className="icon"><ArrowRightSharpIcon /></span>
            ...
            <h1 className='white headingTop1'>Learning Python for Data Analysis and Visualization</h1>
       
            <h3 className='white'>Learn python and how to use it to analyze,visualize and present data. Includes tons of sample code and hours of video!</h3>

            <div>
                <span className=' Ybox'>Bestseller</span>
                <span className='darkyellow'>4.3<span><StarPurple500SharpIcon/><StarPurple500SharpIcon/><StarPurple500SharpIcon/><StarPurple500SharpIcon/><StarHalfSharpIcon/></span></span>
            ...
            <div className='white BBbottom' >
                <span className='BBicons'><ReportIcon/></span>
                <span className='BBbottomText'>Last updated 9/2019</span>
                <span className='BBicons'> <PublicTwoToneIcon/></span>
                <span className='BBbottomText'>English</span>
                <span className='BBicons'><ClosedCaptionRoundedIcon/></span>
                <span className='BBbottomText'>English [Auto], Indonesian [Auto], </span>
...
{/* --------------------------------------------------------------- */}
           ...
           <div className='flex'>
               <table  >
                    ...
                    <tr className='MLcon flex'>
                        <td className='MLcon flex'>
                            <span><DoneRoundedIcon/></span>
                            <p>Learn how to work with various data formats within python, including: JSON,HTML, and MS Excel Worksheets.</p>
       ...
       <div className='CourseContent'>
           ...
           <div className='flex'><p>15 sections • 110 lectures • 21h 5m total length</p>
           <h5 className='Expand'>Expand all sectons</h5></div>
           ...
           <div className='CourceBoxs'>
                <List sx={{ width: '100%' }}>
                 ...
                 <ListItemButton onClick={handleClick}>
                   ...
                   {open ? <ExpandLess className="openArrow"/> : <ExpandMore className="openArrow"/>}
                    <h4>Intro to Course and Python</h4>
                    <span className='CourseCTime'>2 lecture  •  7 min</span></div>
           ...
           <div className='CourceBoxs'>
                <List sx={{ width: '100%' }}>
                 ...
                 <ListItemButton onClick={handleClick}>
                   ...
                   {open ? <ExpandLess className="openArrow"/> : <ExpandMore className="openArrow"/>}
                    <h4>Setup</h4>
                    <span className='CourseCTime'>3 lecture  •  17 min</span></div>
                ...
                <List sx={{ width: '100%' }}>
                 ...
                 <ListItemButton onClick={handleClick}>
                   ...
                   {open ? <ExpandLess className="openArrow"/> : <ExpandMore className="openArrow"/>}
                    ...
                    <span className='CourseCTime'>8 lecture  • 1hr 7 min</span></div>
